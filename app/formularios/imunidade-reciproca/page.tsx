...
export default function ImunidadeReciprocaPage() {
  ...
  // NOVO: Estado para o Ofício Assinado
  const [docOficio, setDocOficio] = useState<File | null>(null);
  ...
  const isSectionValid = (section: number): boolean => {
    switch (section) {
      ...
      case 5: // Documentos (atualizados com ofício)
        return !!(
          docEstatuto &&
          docAtaDiretoria &&
          docImovel &&
          ...
          docDemonstracao &&
          docCertidaoNegativa &&
          docOficio // NOVO: Ofício obrigatório
        );
      case 6: // Preferências
        const selectedCount = [
          preferenciaAR,
  ...
  const preencherDadosAleatorios = () => {
    ...
    switch (activeSection) {
      ...
      case 5:
        ...
        setDocOficio(dados.documentos?.[1] || null); // NOVO
        break;
      case 6:
  ...
  return (
    <div className={styles.page}>
      <Header 
        ...
        title="Imunidade Recíproca entre Entes Federativos"
        description="Imunidade tributária para órgãos públicos."
      />
          ...
          <div className={styles.explanationContent}>
            ...
            <div className={styles.explanationTextContainer}>
              ...
              <div className={styles.explanationText}>
                ...
                <p>
                  <strong>Documentos necessários:</strong> Documentação do ente público, certidão de matrícula do imóvel, comprovante de destinação do imóvel, ofício assinado e outros documentos que serão solicitados ao longo do formulário.
                </p>
        ...
        >
          ...
          {expandedSections.includes(5) && (
            ...
            >
              ...
              {/* Destaque para o Ofício - Campo Prioritário */}
              <div className={styles.alertBox}>
                <div className={styles.alertContent}>
                  <span className={styles.alertTitle}>
                    <WarningIcon sx={{ fontSize: 28, color: "#EB5F1A" }} />
              ...
              {/* Campo do Ofício em Destaque */}
              <div className={styles.uploadField} style={{ marginBottom: "30px", padding: "20px", border: "2px solid #EB5F1A", borderRadius: "8px", backgroundColor: "#fff8f0" }}>
                <label className={styles.labelDoc} style={{ fontSize: "14px", fontWeight: "600", display: "flex", alignItems: "center", gap: "8px" }}>
                  <DescriptionIcon sx={{ fontSize: 20 }} />
                  Ofício Assinado do Órgão Público <span className={styles.required}>*</span>
                </label>
                <label className={styles.uploadButton}>
                  <CloudUploadIcon sx={{ marginRight: "8px" }} />
                  Anexar arquivo
                ...
                {docOficio && (
                  <p className={styles.fileName}>{docOficio.name}</p>
                )}
              </div>

              {/* Demais Documentos
              <h3 style={{ marginBottom: "15px", fontSize: "18px", color: "#333" }}>Demais Documentos Obrigatórios:</h3>
               */}
              <div className={styles.uploadGrid}>
                {[
                  {

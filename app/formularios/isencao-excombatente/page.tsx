...
export default function IsencaoExcombatentePage() {
  ...
  const [expandedSections, setExpandedSections] = useState<number[]>([]); // Seções começam fechadas
  ...
  const [docExcombatente, setDocExcombatente] = useState<File | null>(null);
  ...
  const isSectionValid = (section: number): boolean => {
    switch (section) {
      ...
      case 3: // Procurador (moved from section 6)
        if (possuiProcurador) {
        ...
        return true;
      case 4: // Localização (moved from section 3)
        const imovelValid =
      ...
      case 5: // Documentos (moved from section 4)
        return !!(
          docResidencia &&
          docRgCpf &&
          docEscritura &&
      ...
      case 6: // Questionário (moved from section 5)
        // Perfil e Estado Civil são obrigatórios
  ...
  const handleEstadoCivilChange = (valor: string) => {
    ...
    // Limpa dados do cônjuge se o novo estado civil não requer cônjuge
    ...
    if (isSectionValid(9)) {
      ...
      const dadosFormulario = {
        ...
        documentosAnexados: [
          ...
          docEscritura ? "Prova de Propriedade do Imóvel" : null,
          docRendimentos ? "Comprovante de Rendimentos" : null,
          docExcombatente ? "Documento de Ex-Combatente" : null,
        ...
        nomesArquivos: {
          ...
          docExcombatente: docExcombatente?.name || "",
      ...
      const arquivos = {
        ...
        docExcombatente: docExcombatente,
  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
          ...
          <div className={styles.explanationContent}>
            ...
            <div className={styles.explanationTextContainer}>
              ...
              <div className={styles.explanationText}>
                <p>
                  <strong>Quem tem direito?</strong> Ex-combatentes da Segunda Guerra Mundial e seus dependentes (cônjuge ou companheiro sobrevivente) que sejam proprietários de único imóvel residencial.
                </p>
                <p>
                  <strong>O que você precisa saber:</strong>
                </p>
                <ul>
                  <li>Ser ex-combatente da Segunda Guerra Mundial ou dependente</li>
                  <li>O imóvel deve ser sua única propriedade</li>
                  <li>O imóvel deve ser utilizado para moradia própria</li>
                  <li>Apresentar documentação que comprove a condição de ex-combatente</li>
                </ul>
                <p>
                  <strong>Documentos necessários:</strong> Certificado de ex-combatente, certidão de matrícula do imóvel, RG, CPF, comprovante de residência e outros documentos que serão solicitados ao longo do formulário.
                </p>
        ...
        {/* Seção 3 - Procurador (movida da seção 6) */}
        <section
          data-section="3"
          className={`${styles.section} ${
        ...
        {/* Seção 4 - Localização do Imóvel (movida da seção 3) */}
        <section
          data-section="4"
          className={`${styles.section} ${
        ...
        {/* Seção 5 - Documentação (movida da seção 4) */}
        <section
          data-section="5"
          className={`${styles.section} ${
            ...
            >
              ...
              <div className={styles.uploadGrid}>
                {[
                  ...
                  {
                    label: "Prova de Propriedade do Imóvel",
                    file: docEscritura,
                  ...
                  {
                    label: "Documento de Ex-Combatente",
                    file: docExcombatente,
                    setFile: setDocExcombatente,
                  },
                  {
        ...
        {/* Seção 6 - Questionário de Elegibilidade (movida da seção 5) */}
        <section
          data-section="6"
          className={`${styles.section} ${
        ...
        >
          ...
          >
            <h2 className={styles.sectionTitle}>
              06. Questionário de Elegibilidade
            </h2>
            <div className={styles.sectionHeaderIcons}>
          ...
          <div className={styles.infoCards}>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                <h4 className={styles.infoCardTitle}>Prazo de Decisão</h4>
                <p className={styles.infoCardText}>
                  Após a entrega de toda a documentação correta, a Secretaria
                  tem o prazo de <strong>15 dias</strong> para realizar o
                  reconhecimento do benefício (§ 3º).
                </p>
              </div>
            </div>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                ...
                <p className={styles.infoCardText}>
                  Se o imóvel tiver dívidas de anos anteriores, você será
                  notificado para regularizá-las em <strong>30 dias</strong>. Se
                  não pagar ou parcelar, o pedido de isenção será indeferido (§
                  2º).
                </p>
              </div>
            </div>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                <h4 className={styles.infoCardTitle}>Renovação (Art. 18)</h4>
                <p className={styles.infoCardText}>
                  A isenção deve ser renovada periodicamente. Para isso, você
                  precisará apresentar novamente esses documentos e informar o
            ...
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                <h4 className={styles.infoCardTitle}>
                  Prazo de Entrada (Art. 19)
                </h4>
                <p className={styles.infoCardText}>
                  A prefeitura define anualmente, via Decreto, o período exato
                  para protocolar esses pedidos. É importante conferir o{" "}
                  <strong>calendário fiscal do município</strong> deste ano.
                </p>
              </div>
            </div>
          </div>

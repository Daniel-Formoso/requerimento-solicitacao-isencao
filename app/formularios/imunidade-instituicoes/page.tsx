...
export default function ImunidadeInstituicoesPage() {
  ...
  const [rgProcuradorError, setRgProcuradorError] = useState("");
  const [orgaoEmissorProcuradorError, setOrgaoEmissorProcuradorError] = useState("");
  ...
  // Estados da Seção 4 - Localização
  ...
  const [docComprovanteResidencia, setDocComprovanteResidencia] = useState<File | null>(null);
  const [docCartaoCnpj, setDocCartaoCnpj] = useState<File | null>(null);
  const [docFolhaPagamento, setDocFolhaPagamento] = useState<File | null>(null);
  ...
  // Estados da Seção 6 - Preferências
  ...
  const handleSubmit = async () => {
    if (isSectionValid(7)) {
      ...
      const dadosFormulario = {
        formularioSlug: "imunidade-instituicoes",
  ...
  const preencherDadosAleatorios = () => {
    ...
    switch (activeSection) {
      ...
      case 5:
        ...
        setDocComprovanteResidencia(dados.documentos?.[1] || null);
        setDocCartaoCnpj(dados.documentos?.[0] || null);
        setDocFolhaPagamento(dados.documentos?.[1] || null);
        setDocDeclaracaoEntidade(dados.documentos?.[0] || null);
        setDocDemonstracao(dados.documentos?.[1] || null);
        setDocCertidaoNegativa(dados.documentos?.[0] || null);
        break;
      case 6:
  ...
  return (
    <div className={styles.page}>
      <Header
        ...
        title="Imunidade para Instituições sem Fins Lucrativos"
        description="Imóvel destinado ao funcionamento de instituições educacionais ou de assistência social."
      />
              ...
              <div className={styles.uploadGrid}>
                {[
                  ...
                  },
                  {
                    ...
                    file: docComprovanteResidencia,
                    setFile: setDocComprovanteResidencia,
                  },
                  {
                    label: "Cartão CNPJ",
                    file: docCartaoCnpj,
                    setFile: setDocCartaoCnpj,
                  },
                  {
                    label: "Folha de pagamento dos últimos 3 meses",
                    file: docFolhaPagamento,
            ...
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                ...
                <p className={styles.infoCardText}>
                  Se alguma instituição não tiver CNPJ individualizado, a prefeitura solicitará que a entidade providencie essa inscrição (§ 2º).
                </p>
              </div>
            </div>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                ...
                <p className={styles.infoCardText}>
                  Se a instituição não tiver cadastro mobiliário, a Secretaria de Finanças fará essa inscrição de forma automática (&quot;de ofício&quot;) durante o processo (§ 1º).
                </p>
              </div>
            </div>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                ...
                <p className={styles.infoCardText}>
                  A isenção só vale para os imóveis (ou partes deles) utilizados efetivamente para as atividades institucionais. Prédios usados para fins comerciais pela entidade, por exemplo, podem não ser isentos (§ 3º).
                </p>
              </div>
            </div>
            <div className={styles.infoCard}>
              ...
              <div className={styles.infoCardContent}>
                ...
                <p className={styles.infoCardText}>
                  Embora o texto fale em &quot;isenção&quot;, instituições de educação e assistência social sem fins lucrativos possuem imunidade tributária garantida pela Constituição Federal. O processo descrito no Art. 12 serve para que a prefeitura reconheça oficialmente esse direito e pare de gerar as cobranças.
                </p>
              </div>
            </div>
          </div>

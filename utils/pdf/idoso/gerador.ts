...
// Interface específica para o processo de Idoso
export interface IdosoFormData extends BasePdfFormData {
  ...
  <div class="section">
    ...
    <div class="info-grid">
      ...
      <div class="info-item">
        ...
        <div class="info-value bool-value"><span class="${
          data.coproprietario ? "sim" : "nao"
        }">${data.coproprietario ? "Sim" : "Não"}</span></div>
      </div>
      <div class="info-item">
        <div class="info-label">Origem da Renda</div>
  ...
  <div class="section">
    ...
    <div class="info-grid" style="margin-bottom: 8px;">
      <div class="info-item">
        ...
        <div class="info-value bool-value"><span class="${
          data.assinaturaRogo ? "sim" : "nao"
        }">${data.assinaturaRogo ? "Sim" : "Não"}</span></div>
      </div>
    </div>
    ...
    <div style="margin-bottom: 8px;">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <div class="info-value">${formatValueOptional(
            data.testemunha1OrgaoEmissor
          )}</div>
        </div>
        <div class="info-item">
          <div class="info-label">Telefone</div>
...
export async function generatePdfIdoso(data: IdosoFormData): Promise<Buffer> {
...
export async function generateRequerimentoPdf(data: IdosoFormData): Promise<Buffer> {
  return generatePdfIdoso(data);
}

export async function getIdosoFileName(data: IdosoFormData): Promise<string> {
  const nomeLimpo = sanitizeFileName(data.nome || "Requerimento");
  return `Requerimento_Idoso_${nomeLimpo}.pdf`;
}
